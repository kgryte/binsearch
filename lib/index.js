...
*
*	NOTES:
*		[1] The returned bin index is zero-based and corresponds to the input edge vector as follows:

			edges: | e_0 | e_1 | e_2 |  ... |  e_n  |
			bins: 	  | b_0 | b_1 | ... | b_n-1 |

*		[2] Accordingly, the hypothetical bin vector has length equal to edges.length-1, and thus, the max bin index is edges.length-1. Any value exceeding the max edge has a bin index equal to edges.length.
*
*	TODO:
*		[1] 
*
